...
public:
	...
	AutoHighway() : IModule(0x0, Category::MISC, "Automaticly builds a long ass fuck highway : DEV BY TONY!!! : )") {
		//registerBoolSetting("AirPlace", &AutoHighwayAirPlace, AutoHighwayAirPlace);
		registerBoolSetting("x+", &xplus, xplus);
		registerIntSetting("legnth", &lenght, lenght,1 , 10000);
